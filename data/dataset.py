...
class SSL_Dataset(ImageFolder):
    def __init__(self, transform=None,
                 root="/apdcephfs/share_1290939/0_public_datasets/imageNet_2012/", target_transform=None, is_valid_file=None):
...
class ImageNet(ImageFolder):
    def __init__(self, train, transform=None):
        root = "/apdcephfs/share_1290939/0_public_datasets/imageNet_2012/{}".format('train' if train else 'val')
